...
class Slider {
  ...
  _onMove(e: TouchEvent | MouseEvent): void {
    ...
    const { off, on } = state
    const moveX = x - on.x
    const moveY = (this.getPos(e) as { x: number; y: number }).y - on.y
...
// Fix binding via prototype after class definition
Slider.prototype.onDown = function (this: Slider, e: TouchEvent | MouseEvent) {
  this._onDown(e)
}
Slider.prototype.onUp = function (this: Slider) {
  this._onUp()
}
Slider.prototype.onMove = function (this: Slider, e: TouchEvent | MouseEvent) {
  this._onMove(e)
}
...
// Slide data — troque as imagens pelos seus projetos reais
const slides = [
  { left: undefined, img: 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/58281/tex1.jpg', title: 'Projeto 01' },
...
export function ProjectsSection({
  ...
  return (
    <section ref={sectionRef} id="projetos" className="projects-section projects-webgl-section">
      ...
      <div className="titles">
        ...
        <div className="titles__list js-titles">
          ...
          {/* extra item to close the loop smoothly */}
