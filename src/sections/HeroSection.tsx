  ...
  return (
    <section className="hero-section" id="inicio">
      ...
      >
        ...
        <div className="hero-tracery-hud" aria-hidden="true">
          <span className="hero-hud-line hero-hud-line-top" />
          <span className="hero-hud-line hero-hud-line-right" />
          <span className="hero-hud-line hero-hud-line-bottom" />
          <span className="hero-hud-line hero-hud-line-left" />
          <span className="hero-hud-box hero-hud-box-a" />
          <span className="hero-hud-box hero-hud-box-b" />
          <span className="hero-hud-number hero-hud-number-a">01</span>
          <span className="hero-hud-number hero-hud-number-b">23</span>
          <span className="hero-hud-number hero-hud-number-c">89</span>
        </div>
